...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 sm:flex-row sm:justify-start sm:flex-row-reverse border-t border-[var(--ds-border)] pt-4 mt-2",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-extrabold text-[var(--ds-foreground)]", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-sm leading-relaxed text-[var(--ds-foreground-soft)]", className)}
    {...props}
  />
))
